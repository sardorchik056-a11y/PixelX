...
MAIN_TEXT = (
    ...
    f'<blockquote>'
    f'<b><tg-emoji emoji-id="5197288647275071607">👋</tg-emoji> Честные игры — прозрачные правила и реальные шансы на победу. '
    f'Без скрытых условий, всё открыто и по-настоящему честно.'
    f'</blockquote>\n\n'
    f'<blockquote>'
    f'<tg-emoji emoji-id="5262517101578443800">👋</tg-emoji> Испытай свои навыки в мини-играх, набирай очки, поднимайся в таблице лидеров '
    f'и стань одним из лучших игроков PixelX.</b>'
    f'</blockquote>\n\n'
)
